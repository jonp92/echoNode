...
export default function notifyClients(eventName, data) {
...
function setupAudio() {
    ...
    ap.onEvent('timeposition', (seconds) => {
...
function matchApiAction(category, path) {
...
async function saveArtwork(picture) {
